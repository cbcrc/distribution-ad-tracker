...
var _apiClient = __webpack_require__(14);
...
_apiClient2.default.helpers = _apiClient2.default.helpers || {};
_apiClient2.default.prototype.observers = _apiClient2.default.observers || {};
// Install internal queue
_apiClient2.default.on('client', function (client) {
  client.extensions = {
    events: [],
    collections: {}
  };
...
var _deepExtend = __webpack_require__(21);
...
exports.MurdockTracking = exports.Murdock = exports.MurdockGlobals = undefined;
...
var _recordEventsBrowser = __webpack_require__(19);

var _deferEvents = __webpack_require__(26);

var _extendEvents = __webpack_require__(9);

var _browserAutoTracking = __webpack_require__(27);

var _getBrowserProfile = __webpack_require__(29);

var _getDatetimeIndex = __webpack_require__(30);

var _getDomainName = __webpack_require__(31);

var _getDomNodePath = __webpack_require__(12);

var _getDomNodeProfile = __webpack_require__(32);

var _getScreenProfile = __webpack_require__(10);

var _getScrollState = __webpack_require__(33);

var _getUniqueId = __webpack_require__(34);

var _getWindowProfile = __webpack_require__(11);

var _cookie = __webpack_require__(35);
...
var MurdockGlobals = exports.MurdockGlobals = undefined;
if (typeof webpackMurdockGlobals !== 'undefined') {
  exports.MurdockGlobals = MurdockGlobals = webpackMurdockGlobals;
}
...
var Murdock = exports.Murdock = _index2.default.extendLibrary(_index2.default); // deprecated, left for backward compatibility
var MurdockTracking = exports.MurdockTracking = Murdock;
exports.default = Murdock;
...
(function (env) {
  ...
  var each = __webpack_require__(0),
      ...
      serialize = __webpack_require__(16);
...
}).call(undefined, typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {});
...
var _fetchRetry = __webpack_require__(22);
...
function recordEvent(eventCollectionOrConfigObject, eventBody, callback) {
  ...
  var data = { event: eventCollectionOrConfigObject.collection };
...
function send(_ref) {
  ...
  // even if your global client's config prefers Fetch
      ...
      var blob = new Blob([JSON.stringify({ data: _base2.default.encode(JSON.stringify(extendedEventsHash)) })], { type: 'application/json; charset=UTF-8' }); // the blob
  ...
  utf8: {
    encode: function encode(n) {
      ...
      var o = "",
          ...
          c;
      while (i < n.length) {
        c = n.charCodeAt(i++);o = o + (c < 128 ? cc(c) : c > 127 && c < 2048 ? cc(c >> 6 | 192) + cc(c & 63 | 128) : cc(c >> 12 | 224) + cc(c >> 6 & 63 | 128) + cc(c & 63 | 128));
      }return o;
    },
    decode: function decode(n) {
      "use strict";
      ...
      while (i < n.length) {
        c = n.charCodeAt(i);
        o = o + (c < 128 ? [cc(c), i++][0] : c > 191 && c < 224 ? [cc((c & 31) << 6 | (c2 = n.charCodeAt(i + 1)) & 63), i += 2][0] : [cc((c & 15) << 12 | ((c2 = n.charCodeAt(i + 1)) & 63) << 6 | (c3 = n.charCodeAt(i + 2)) & 63), i += 3][0]);
      }return o;
    }
  }
};
...
var _cacheBrowser = __webpack_require__(25);
...
function deferEvent(eventCollection, eventBody) {
  ...
  if (eventBody) eventBody.event = eventCollection;
...
function initAutoTrackingCore(lib) {
    return function (obj) {
        ...
        var cookie = new utils.cookie('distribution-adops');
        ...
        if (options.collectGeo === true) {
            ...
            if (typeof geoip_city === "function") geo.city = geoip_city();

            if (typeof geoip_region === "function") geo.region = geoip_region();

            if (typeof geoip_country_name === "function") geo.country = geoip_country_name();

            if (typeof geoip_latitude === "function" && typeof geoip_longitude === "function") geo.location = { "lat": geoip_latitude(), "lon": geoip_longitude() };
        }
        var is_adblock_active = false;
        ...
        if (options.recordClicks === true) {
            utils.listener('a, a *').on('click', function (e) {
                ...
                if (options.catchError) {
                    return client.deferEvent('clicks', event).catch(function (err) {
                        options.catchError(err);
                    });
                }

                return client.deferEvent('clicks', event);
            });
        }

        if (options.recordPageViews === true) {
            if (options.catchError) {
                client.deferEvent('pageviews').catch(function (err) {
                    options.catchError(err);
                });
            } else {
                client.deferEvent('pageviews');
            }
        }
        ...
        if (options.recordPageViewsOnExit && typeof window !== 'undefined') {
            window.addEventListener('beforeunload', function () {
                ...
                client.deferEvent('pageview_exit');
                client.recordDeferredEvents();
            });
        }
        ...
        if (options.recordPlayVideos === true) {
            ...
            var record_video_event = function record_video_event(type, video) {
                ...
                client.deferEvent('videos', event_data);
            };

            var is_play_recorded = false;
            var send_play_record_event = function send_play_record_event(video) {
                if (is_play_recorded === true) return;
                is_play_recorded = true;
                record_video_event("play", video);
            };
            var locateVideoElement = function _self(DOM) {
                if (!DOM) return;
            ...
            var observe = function _self() {
                ...
                var gotVideo = function gotVideo(video) {
                ...
                {
                    // Existing video
                    var video = locateVideoElement(DOM);
                ...
                var callback = function callback(mutationList) {
                    mutationList.forEach(function (mutation) {
                        mutation.addedNodes.forEach(function (node) {
                            var search = function search(node, tag) {
...

                            {
                                ...
                                var _video = search(node, "video");
                                if (_video) gotVideo(_video);
                            }

                            {
                                // Dynamically added iframe
                                var iframe = search(node, "iframe");
                                if (iframe) {
                                    try {
                ...
                var observer = new _window.MutationObserver(callback);
        ...
        if (options.recordPaidVideos === true) {
            ...
            window.addEventListener("message", function (event) {
                if (/^ima:\/\//.test(event.data)) {
                    var json_data = JSON.parse(event.data.substr(6));
                    if (json_data && json_data.name === "adsManager" && ["remainingTime", "adProgress"].indexOf(json_data.type) === -1) {
                        ...
                        var ad_data = JSON.parse(JSON.stringify(json_data.data));
                        ad_data.creativeId = creativeId;
                        ad_data.adId = adId;
                        var event_data = { ad_event: json_data.type, ad_data: ad_data };
                    ...
                    client.deferEvent('event_data', _event_data);
                }
            });
        }
        ...
        if (options.recordErrors === true) {
            ...
            window.onerror = function (message, file, line, column, errorObj) {
                var error_data = { msg: message, file: file, line: line, column: column };
                if (errorObj) {
        ...
        if (options.recordPerformance === true) {
            var record_performance = function record_performance(entry) {
                try {
                    var event = {
                        event_data: {
                            "name": entry.name,
...
module.exports = JSON.parse("{\"name\":\"murdock\",\"version\":\"0.0.2\",\"description\":\"Track events - custom user actions, clicks, pageviews, purchases.\",\"main\":\"dist/lib.js\",\"scripts\":{\"build\":\"NODE_ENV=production webpack -p && NODE_ENV=production OPTIMIZE_MINIMIZE=1 webpack -p && npm run build:node\",\"build:node\":\"TARGET=node NODE_ENV=production webpack -p\",\"build:dev\":\"NODE_ENV=dev API_HOST=murdock.qa.camr.io webpack -p\",\"build:prod\":\"NODE_ENV=production API_HOST=murdock.prod.camr.io webpack -p\",\"profile\":\"webpack --profile --json > stats.json\",\"analyze\":\"webpack-bundle-analyzer stats.json /dist\",\"preversion\":\"npm run build:node && npm run test\",\"version\":\"npm run build && git add .\",\"postversion\":\"git push && git push --tags && npm publish\",\"build:deploy:prod\":\"npm run build:prod && ./deploy.sh\",\"build:deploy:dev\":\"npm run build:dev && ./deploy.sh\"},\"dependencies\":{\"component-emitter\":\"^1.3.0\",\"dotenv-webpack\":\"^1.7.0\",\"js-cookie\":\"2.1.0\",\"promise-polyfill\":\"^8.0.0\",\"uglifyjs-webpack-plugin\":\"^2.2.0\",\"whatwg-fetch\":\"^2.0.4\"},\"devDependencies\":{\"babel-core\":\"^6.26.3\",\"babel-jest\":\"^23.0.1\",\"babel-loader\":\"^7.1.5\",\"babel-plugin-transform-es2015-modules-commonjs\":\"^6.26.2\",\"babel-plugin-transform-object-rest-spread\":\"^6.26.0\",\"babel-polyfill\":\"^6.26.0\",\"babel-preset-env\":\"^1.7.0\",\"babel-preset-es2015\":\"^6.24.1\",\"babel-preset-stage-0\":\"^6.24.1\",\"eslint\":\"^4.19.1\",\"eslint-config-airbnb\":\"^16.1.0\",\"eslint-loader\":\"^2.0.0\",\"eslint-plugin-import\":\"^2.11.0\",\"eslint-plugin-jsx-a11y\":\"^6.0.3\",\"html-loader\":\"^0.5.5\",\"html-webpack-plugin\":\"^3.2.0\",\"jest\":\"^22.4.3\",\"jest-fetch-mock\":\"^1.6.5\",\"merge\":\"^1.2.1\",\"nock\":\"^9.2.6\",\"regenerator-runtime\":\"^0.11.1\",\"replace-in-file\":\"^3.4.0\",\"terser-webpack-plugin\":\"^2.3.2\",\"url-parse\":\"^1.4.3\",\"webpack\":\"^4.41.5\",\"webpack-bundle-analyzer\":\"^3.3.2\",\"webpack-cli\":\"^3.3.10\",\"webpack-dev-server\":\"^3.9.0\",\"xhr-mock\":\"^2.3.2\"}}");
