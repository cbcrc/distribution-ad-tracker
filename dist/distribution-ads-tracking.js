...
var configDefault = exports.configDefault = {
  ...
  api_config: {
    host: 'x537lu8ifk.execute-api.ca-central-1.amazonaws.com/dev',
    basePath: 'log',
    protocol: 'https',
    requestType: 'json'
  },
...
module.exports = {"name":"distribution-ad-monitor","version":"4.4.1","description":"Track events - custom user actions, clicks, pageviews, purchases.","main":"dist/node/distribution-ad-monitor.js","browser":"dist/distribution-ad-monitor.js","scripts":{"start":"NODE_ENV=development webpack-dev-server","test":"NODE_ENV=test jest && npm run test:node","test:node":"NODE_ENV=test TEST_ENV=node jest","test:watch":"NODE_ENV=test jest --watch","test:node:watch":"NODE_ENV=test TEST_ENV=node jest --watch","build":"NODE_ENV=production webpack -p && NODE_ENV=production OPTIMIZE_MINIMIZE=1 webpack -p && npm run build:node","build:node":"TARGET=node NODE_ENV=production webpack -p","profile":"webpack --profile --json > stats.json","analyze":"webpack-bundle-analyzer stats.json /dist","preversion":"npm run build:node && npm run test","version":"npm run build && git add .","postversion":"git push && git push --tags && npm publish","demo":"node ./test/demo/index.node.js"},"license":"MIT","dependencies":{"component-emitter":"^1.2.0","js-cookie":"2.1.0","promise-polyfill":"^8.0.0","whatwg-fetch":"^2.0.4"},"devDependencies":{"babel-core":"^6.26.3","babel-jest":"^23.0.1","babel-loader":"^7.1.5","babel-plugin-transform-es2015-modules-commonjs":"^6.26.2","babel-plugin-transform-object-rest-spread":"^6.26.0","babel-polyfill":"^6.26.0","babel-preset-env":"^1.7.0","babel-preset-es2015":"^6.24.1","babel-preset-stage-0":"^6.24.1","eslint":"^4.19.1","eslint-config-airbnb":"^16.1.0","eslint-loader":"^2.0.0","eslint-plugin-import":"^2.11.0","eslint-plugin-jsx-a11y":"^6.0.3","html-loader":"^0.5.5","html-webpack-plugin":"^3.2.0","jest":"^22.4.3","jest-fetch-mock":"^1.6.5","merge":"^1.2.1","nock":"^9.2.6","regenerator-runtime":"^0.11.1","replace-in-file":"^3.4.0","url-parse":"^1.4.3","webpack":"^4.5.0","webpack-bundle-analyzer":"^3.3.2","webpack-cli":"^3.3.10","webpack-dev-server":"^3.9.0","xhr-mock":"^2.3.2"}};
...
var _apiClient = __webpack_require__(43);
...
_apiClient2.default.version = _package2.default.version;
  ...
  return function (obj) {
    ...
    if (options.recordElementViews === true) {
      if (typeof IntersectionObserver !== 'undefined') {
        ...
        var target = document.querySelectorAll('#iOffrez');
    ...
    if (options.recordAjaxCalls === true) {
      ...
      window.XMLHttpRequest.prototype.open = function (method, url) {
        ...
        this.extractedData = {};
        var extract = this.tokenExtraction;
      };
...
(function (env) {
  ...
  function Client(props) {
    ...
    this.configure(_configDefault2.default.api_config);
  ...
  Client.prototype.configure = function (obj) {
    this.config = obj || {};
    this.config.resources = extend({}, Client.resources);
...
exports.DistributionAdsTracking = exports.DistributionAds = exports.distributionAdsGlobals = undefined;
...
var distributionAdsGlobals = exports.distributionAdsGlobals = undefined;
if (typeof webpackDistributionAdsGlobals !== 'undefined') {
  exports.distributionAdsGlobals = distributionAdsGlobals = webpackDistributionAdsGlobals;
}
...
var DistributionAds = exports.DistributionAds = _index2.default.extendLibrary(_index2.default); // deprecated, left for backward compatibility
var DistributionAdsTracking = exports.DistributionAdsTracking = DistributionAds;
exports.default = DistributionAds;
...
//# sourceMappingURL=distribution-ads-tracking.js.map